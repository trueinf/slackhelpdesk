...
import { Hash, Users, Search, Info, Star, Settings } from 'lucide-react';
...
export const ChatHeader = ({
  ...
  // @return
  return <div className="flex items-center justify-between px-4 py-3 border-b border-gray-200 bg-white" data-magicpath-id="0" data-magicpath-path="ChatHeader.tsx">
      <div className="flex items-center space-x-3 flex-1 min-w-0" data-magicpath-id="1" data-magicpath-path="ChatHeader.tsx">
        <div className="flex items-center space-x-2" data-magicpath-id="2" data-magicpath-path="ChatHeader.tsx">
          <Hash className="w-4 h-4 text-gray-500" data-magicpath-id="3" data-magicpath-path="ChatHeader.tsx" />
        ...
        {topic && <div className="hidden md:block" data-magicpath-id="8" data-magicpath-path="ChatHeader.tsx">
            <span className="text-sm text-gray-600 border-l border-gray-300 pl-3 truncate" data-magicpath-id="9" data-magicpath-path="ChatHeader.tsx">
              {topic}
            </span>
          </div>}
      </div>

      <div className="flex items-center space-x-2" data-magicpath-id="10" data-magicpath-path="ChatHeader.tsx">
        <button className="p-2 hover:bg-gray-100 rounded-md transition-colors" data-magicpath-id="11" data-magicpath-path="ChatHeader.tsx">
          <Star className="w-4 h-4 text-gray-500" data-magicpath-id="12" data-magicpath-path="ChatHeader.tsx" />
        </button>
        ...
        <button className="p-2 hover:bg-gray-100 rounded-md transition-colors" data-magicpath-id="13" data-magicpath-path="ChatHeader.tsx">
          <Search className="w-4 h-4 text-gray-500" data-magicpath-id="14" data-magicpath-path="ChatHeader.tsx" />
        </button>
        ...
        <button className="p-2 hover:bg-gray-100 rounded-md transition-colors" data-magicpath-id="15" data-magicpath-path="ChatHeader.tsx">
          <Info className="w-4 h-4 text-gray-500" data-magicpath-id="16" data-magicpath-path="ChatHeader.tsx" />
        </button>
        ...
        <button className="p-2 hover:bg-gray-100 rounded-md transition-colors" data-magicpath-id="17" data-magicpath-path="ChatHeader.tsx">
          <Settings className="w-4 h-4 text-gray-500" data-magicpath-id="18" data-magicpath-path="ChatHeader.tsx" />
        </button>
      </div>
    </div>;
};